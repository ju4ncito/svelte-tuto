<script>
  import Header from "./section3/design/Header.svelte";
  import CardGrid from "./section3/posts/CardGrid.svelte";
  import InputCustom from "./section3/design/InputCustom.svelte";
  import Jumbotron from "./section3/design/Jumbotron.svelte";
  const color = "light";
  let titulo = "";
  let imagen = "";
  let descripcion = "";
